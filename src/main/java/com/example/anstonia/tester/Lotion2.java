...
import static com.example.anstonia.tester.R.layout.activity_lotion2;


public class Lotion2 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_lotion2);
        initHaptics();
    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus) {
            try {
                ...
                ImageView view = (ImageView) findViewById(R.id.lotion2);
